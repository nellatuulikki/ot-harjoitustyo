...
class Tic_tac_toe_UI:
    ...
    def start(self):
        ...
        b1 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b1, status_label, 0, 0))
        b2 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b2, status_label, 0, 1))
        b3 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b3, status_label, 0, 2))
        b4 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b4, status_label, 1, 0))
        b5 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b5, status_label, 1, 1))
        b6 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b6, status_label, 1, 2))
        b7 = tk.Button(master=self._root, text="", height=5, width=10,
                       command=lambda: self.make_move(b7, status_label, 2, 0))
        b8 = tk.Button(master=self._root, text="", height=5, width=10,
    ...
    def get_game_status(self):
        ...
        if (self.game_board[0][0] == self.game_board[0][1] == self.game_board[0][2] == "X" or self.game_board[1][0] ==
                self.game_board[1][1] == self.game_board[1][2] == "X" or
                self.game_board[2][0] == self.game_board[2][1] == self.game_board[2][2] == "X" or self.game_board[0][
                    0] == self.game_board[1][0] == self.game_board[2][0] == "X" or
                self.game_board[0][1] == self.game_board[1][1] == self.game_board[2][1] == "X" or self.game_board[0][
            ...
            self.winner = self.player1
              ...
              self.game_board[2][0] == self.game_board[2][1] == self.game_board[2][2] == "O" or self.game_board[0][0] ==
              self.game_board[1][0] == self.game_board[2][0] == "O" or
              self.game_board[0][1] == self.game_board[1][1] == self.game_board[2][1] == "O" or self.game_board[0][2] ==
